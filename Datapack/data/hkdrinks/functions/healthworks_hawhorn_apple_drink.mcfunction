#replace Healthworks Hawhorn Apple Drink with Healthworks Hawhorn Apple Drink Block
execute as @a if predicate hkdrinks:healthworks_hawhorn_apple_drink/milk_bucket_in_off_hand run item replace entity @p weapon.offhand with item_frame{display:{Name:'{"translate":"item.hkdrinks.healthworks_hawhorn_apple_drink.name","italic":false}'},CustomModelData:33,EntityTag:{Silent:1b,Tags:["hkdrinks"],Item:{id:"minecraft:item_frame",Count:1b,tag:{CustomModelData:33,hkdrinks:1}},Invisible:1b}} 1

#replace Healthworks Hawhorn Apple Drink Block with Healthworks Hawhorn Apple Drink
execute as @a if predicate hkdrinks:healthworks_hawhorn_apple_drink/item_frame_in_main_hand run item replace entity @p weapon.mainhand with milk_bucket{display:{Name:'{"translate":"item.hkdrinks.healthworks_hawhorn_apple_drink.name","italic":false}'},CustomModelData:33} 1
