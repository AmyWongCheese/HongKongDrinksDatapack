...
#replace Vita Chocolate Milk to Vita Chocolate Milk Cookie
execute as @a if predicate hkdrinks:vita_chocolate_milk/milk_bucket_in_main_hand_is_sneaking run item entity @p weapon.mainhand replace cookie{display:{Name:'{"translate":"item.hkdrinks.vita_chocolate_milk.name","italic":false}'},CustomModelData:5} 1

#replace Vita Chocolate Milk Block or Cookie to Vita Chocolate Milk Drink
execute as @a if predicate hkdrinks:vita_chocolate_milk/item_frame_in_main_hand run item entity @p weapon.mainhand replace milk_bucket{display:{Name:'{"translate":"item.hkdrinks.vita_chocolate_milk.name","italic":false}'},CustomModelData:5} 1
execute as @a if predicate hkdrinks:vita_chocolate_milk/cookie_in_main_hand run item entity @p weapon.mainhand replace milk_bucket{display:{Name:'{"translate":"item.hkdrinks.vita_chocolate_milk.name","italic":false}'},CustomModelData:5} 1
