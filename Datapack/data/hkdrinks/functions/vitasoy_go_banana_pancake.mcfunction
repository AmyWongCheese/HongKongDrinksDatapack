...
execute as @a if predicate hkdrinks:vitasoy_go_banana_pancake/item_frame_in_main_hand run item entity @p weapon.mainhand replace milk_bucket{display:{Name:'{"translate":"item.hkdrinks.vitasoy_go_banana_pancake.name","italic":false}'},CustomModelData:43} 1