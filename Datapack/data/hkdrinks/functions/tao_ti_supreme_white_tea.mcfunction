...
execute as @a if predicate hkdrinks:tao_ti_supreme_white_tea/item_frame_in_main_hand run item entity @p weapon.mainhand replace milk_bucket{display:{Name:'{"translate":"item.hkdrinks.tao_ti_supreme_white_tea.name","italic":false}'},CustomModelData:18} 1