...
execute as @a if predicate hkdrinks:vita_ginger_soya_milk/item_frame_in_main_hand run loot replace entity @p weapon.mainhand loot hkdrinks:vita_ginger_soya_milk