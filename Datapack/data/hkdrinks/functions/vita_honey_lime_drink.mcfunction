...
execute as @a if predicate hkdrinks:vita_honey_lime_drink/item_frame_in_main_hand run replaceitem entity @p weapon.mainhand milk_bucket{display:{Name:'{"translate":"item.hkdrinks.vita_honey_lime_drink.name","italic":false}'},CustomModelData:46} 1
execute as @a if predicate hkdrinks:vita_honey_lime_drink/oxeye_daisy_in_main_hand run replaceitem entity @p weapon.mainhand milk_bucket{display:{Name:'{"translate":"item.hkdrinks.vita_honey_lime_drink.name","italic":false}'},CustomModelData:46} 1