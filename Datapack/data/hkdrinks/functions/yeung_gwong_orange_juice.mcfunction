...
execute as @a if predicate hkdrinks:yeung_gwong_orange_juice/item_frame_in_main_hand run item entity @p weapon.mainhand replace milk_bucket{display:{Name:'{"translate":"item.hkdrinks.yeung_gwong_orange_juice.name","italic":false}'},CustomModelData:47} 1