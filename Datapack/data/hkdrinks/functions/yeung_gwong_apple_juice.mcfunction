#replace Yeung Gwong Apple Juice Drink with Yeung Gwong Apple Juice Block
...
#replace Yeung Gwong Apple Juice Block with Yeung Gwong Apple Juice Drink
execute as @a if predicate hkdrinks:yeung_gwong_apple_juice/item_frame_in_main_hand run item replace entity @p weapon.mainhand with milk_bucket{display:{Name:'{"translate":"item.hkdrinks.yeung_gwong_apple_juice.name","italic":false}'},CustomModelData:32} 1
