...
execute as @a if predicate hkdrinks:yeung_gwong_apple_juice/item_frame_in_main_hand run replaceitem entity @p weapon.mainhand milk_bucket{display:{Name:'{"translate":"item.hkdrinks.yeung_gwong_apple_juice.name","italic":false}'},CustomModelData:32} 1
